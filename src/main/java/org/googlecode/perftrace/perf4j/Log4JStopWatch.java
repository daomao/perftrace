 ...
 * The various constructors allow you to specify the Logger to use (defaults to
 * org.perf4j.TimingLogger), the Level at which messages are normally logged
 * (defaults to INFO) and the Level used for logging if one of the stop or lap
 * methods that takes an exception is called (defaults to WARN).
 * 
 * @author Alex Devine
 * @author zhongfeng add isRootMethod field
 */
...
public class Log4JStopWatch extends LoggingStopWatch {
	...
	/**
	 * Creates a Log4JStopWatch with a blank tag, no message and started at the
	 * instant of creation. The Logger with the name "org.perf4j.TimingLogger"
	 * is used to log stop watch messages at the INFO level, or at the WARN
	 ...
	 * messages at the INFO level, or at the WARN level if an exception is
	...
	public Log4JStopWatch(Logger logger) {
		this("", null, false, logger, Level.INFO, Level.WARN);
	}

	/**
	 * Creates a Log4JStopWatch with a blank tag, no message and started at the
	 * instant of creation, using the specified Logger to log stop watch
	 * messages at the normalPriority level specified, or at the WARN level if
	 * an exception is passed to one of the stop or lap methods.
	 * 
	 * @param logger
	 *            The Logger to use when persisting StopWatches in one of the
	 *            stop or lap methods.
	...
	public Log4JStopWatch(Logger logger, Level normalPriority) {
		this("", null, false, logger, normalPriority, Level.WARN);
	}
	...
	/**
	 * Creates a Log4JStopWatch with the tag specified, no message and started
	 ...
	 * level, or at the WARN level if an exception is passed to one of the stop
	 * or lap methods.
	 * 
	 * @param tag
	 ...
	 *            using dot notation.
	 */
	public Log4JStopWatch(String tag, boolean isRootMethod) {
	 ...
	 * messages at INFO level, or at the WARN level if an exception is passed to
	 ...
	 *            stop or lap methods.
	 */
	public Log4JStopWatch(String tag, boolean isRootMethod, Logger logger) {
		this(tag, null, isRootMethod, logger, Level.INFO, Level.WARN);
	}
	...
	public Log4JStopWatch(String tag, boolean isRootMethod, Logger logger,
		...
		this(tag, null, isRootMethod, logger, normalPriority, Level.WARN);
	}
	...
	/**
	 * Creates a Log4JStopWatch with the tag and message specified and started
	 * at the instant of creation. The Logger with the name
	 * "org.perf4j.TimingLogger" is used to log stop watch messages at the INFO
	 * level, or at the WARN level if an exception is passed to one of the stop
	 * or lap methods.
	 ...
	 *            this StopWatch.
	 */
	public Log4JStopWatch(String tag, String message, boolean isRootMethod) {
	 ...
	 * Creates a Log4JStopWatch with the tag and message specified and started
	 * at the instant of creation, using the specified Logger to log stop watch
	 * messages at INFO level, or at WARN level if an exception is passed to one
	...
	public Log4JStopWatch(String tag, String message, boolean isRootMethod,
			Logger logger) {
		this(tag, message, isRootMethod, logger, Level.INFO, Level.WARN);
	}

	/**
	 * Creates a Log4JStopWatch with the tag and message specified and started
	 * at the instant of creation, using the specified Logger to log stop watch
	 * messages at the normalPriority level specified, or at WARN level if an
	...
	public Log4JStopWatch(String tag, String message, boolean isRootMethod,
		...
		this(tag, message, isRootMethod, logger, normalPriority, Level.WARN);
	}
	...
	/**
	 * Gets the log4j Logger that is used to persist logging statements when one
	 * of the stop or lap methods is called.
	 * 
	...
	// Just overridden to make use of covariant return types
	public Log4JStopWatch setNormalAndSlowSuffixesEnabled(
	...
	/**
	 * The log message is overridden to use the log4j Logger to persist the stop
	 * watch.
	 * 
