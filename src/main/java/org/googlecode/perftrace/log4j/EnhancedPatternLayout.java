...
import org.googlecode.perftrace.log4j.helpers.PatternConverter;
import org.googlecode.perftrace.log4j.pattern.BridgePatternConverter;
...
public class EnhancedPatternLayout extends Layout {
   ...
   * {@link org.googlecode.perftrace.log4j.spi.LoggerRepository LoggerRepository} object store.
   */
  ...
  */
  ...
  public String getConversionPattern() {
    ...
    /**
      ...
      @since 0.9.0
    */
    protected org.googlecode.perftrace.log4j.helpers.PatternParser createPatternParser(String pattern) {
      return new org.googlecode.perftrace.log4j.pattern.BridgePatternParser(pattern);
    }
