...
/**
   ...
   org.googlecode.perftrace.log4j.xml.DOMConfigurator DOMConfigurator} such as
   support custom {@link org.googlecode.perftrace.log4j.spi.ErrorHandler ErrorHandlers},
   nested appenders such as the {@link org.googlecode.perftrace.log4j.AsyncAppender
   AsyncAppender}, etc.
...
public class PropertyConfigurator implements Configurator {
  ...
  /** Key for specifying the {@link org.googlecode.perftrace.log4j.spi.LoggerFactory
  ...
  /**
    ...
    specifying an {@link org.googlecode.perftrace.log4j.or.ObjectRenderer ObjectRenderer}
   ...
   converted to String before being logged. This is done by
   specifying an {@link org.googlecode.perftrace.log4j.spi.ThrowableRenderer ThrowableRenderer}.
...
new PropertyConfigurator().doConfigure(inputStream,
  ...
  */
  ...
  /**
     ...
     {@link org.googlecode.perftrace.log4j.spi.LoggerFactory LoggerFactory}
  ...
  */
          ...
          if (hierarchy instanceof ThrowableRendererSupport) {
            ThrowableRenderer tr = (ThrowableRenderer)
                  OptionConverter.instantiateByKey(props,
                          ...
                          org.googlecode.perftrace.log4j.spi.ThrowableRenderer.class,
                          null);
            if(tr == null) {
                LogLog.error(
  ...
  Appender parseAppender(Properties props, String appenderName) {
    ...
    appender = (Appender) OptionConverter.instantiateByKey(props, prefix,
					      org.googlecode.perftrace.log4j.Appender.class,
					      null);
    if(appender == null) {
      LogLog.error(
