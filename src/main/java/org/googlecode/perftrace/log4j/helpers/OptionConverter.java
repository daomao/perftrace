...
package org.googlecode.perftrace.log4j.helpers;
...
public class OptionConverter {
  ...
  /**
     ...
     character is present, then the default {@link org.googlecode.perftrace.log4j.Level}
  ...
  Level toLevel(String value, Level defaultValue) {
    ...
    try {
      ...
      Class[] paramTypes = new Class[] { String.class,
					 org.googlecode.perftrace.log4j.Level.class
                                       };
 ...
 */
  ...
  */
  ...
  String substVars(String val, Properties props) throws
     ...
     * @param hierarchy
     *            The {@link org.googlecode.perftrace.log4j.Hierarchy} to act on.
     * @since 1.2.17
     */
...
configurator.doConfigure(inputStream, hierarchy);
  ...
  /**
     ...
     {@link org.googlecode.perftrace.log4j.xml.DOMConfigurator} is used.
     @param hierarchy The {@link org.googlecode.perftrace.log4j.Hierarchy} to act on.
  ...
  void selectAndConfigure(URL url, String clazz, LoggerRepository hierarchy) {
   ...
   if(clazz == null && filename != null && filename.endsWith(".xml")) {
     clazz = "org.googlecode.perftrace.log4j.xml.DOMConfigurator";
   }
