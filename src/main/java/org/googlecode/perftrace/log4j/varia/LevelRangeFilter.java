...
/**
   ...
   <p>Refer to the {@link
   org.googlecode.perftrace.log4j.AppenderSkeleton#setThreshold setThreshold} method
   available to <code>all</code> appenders extending {@link
   org.googlecode.perftrace.log4j.AppenderSkeleton} for a more convenient way to
