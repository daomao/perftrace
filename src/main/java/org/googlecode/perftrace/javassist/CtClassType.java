...
package org.googlecode.perftrace.javassist;
...
import org.googlecode.perftrace.javassist.bytecode.AccessFlag;
import org.googlecode.perftrace.javassist.bytecode.AnnotationsAttribute;
import org.googlecode.perftrace.javassist.bytecode.AttributeInfo;
import org.googlecode.perftrace.javassist.bytecode.BadBytecode;
import org.googlecode.perftrace.javassist.bytecode.Bytecode;
import org.googlecode.perftrace.javassist.bytecode.ClassFile;
import org.googlecode.perftrace.javassist.bytecode.CodeAttribute;
import org.googlecode.perftrace.javassist.bytecode.CodeIterator;
import org.googlecode.perftrace.javassist.bytecode.ConstPool;
import org.googlecode.perftrace.javassist.bytecode.ConstantAttribute;
import org.googlecode.perftrace.javassist.bytecode.Descriptor;
import org.googlecode.perftrace.javassist.bytecode.EnclosingMethodAttribute;
import org.googlecode.perftrace.javassist.bytecode.FieldInfo;
import org.googlecode.perftrace.javassist.bytecode.InnerClassesAttribute;
import org.googlecode.perftrace.javassist.bytecode.MethodInfo;
import org.googlecode.perftrace.javassist.bytecode.ParameterAnnotationsAttribute;
import org.googlecode.perftrace.javassist.bytecode.SignatureAttribute;
import org.googlecode.perftrace.javassist.bytecode.annotation.Annotation;
import org.googlecode.perftrace.javassist.compiler.AccessorMaker;
import org.googlecode.perftrace.javassist.compiler.CompileError;
import org.googlecode.perftrace.javassist.compiler.Javac;
import org.googlecode.perftrace.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see org.googlecode.perftrace.javassist.CtClass#prune()
     * @see org.googlecode.perftrace.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
