...
import org.googlecode.perftrace.javassist.compiler.SymbolTable;
import org.googlecode.perftrace.javassist.compiler.ast.ASTree;
import org.googlecode.perftrace.javassist.compiler.ast.DoubleConst;
import org.googlecode.perftrace.javassist.compiler.ast.IntConst;
import org.googlecode.perftrace.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link org.googlecode.perftrace.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see org.googlecode.perftrace.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link org.googlecode.perftrace.javassist.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see org.googlecode.perftrace.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see org.googlecode.perftrace.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
